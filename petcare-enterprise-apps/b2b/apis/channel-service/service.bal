...
service / on new http:Listener(9091) {
    ...
    resource function post meetings(http:Headers headers, @http:Payload MeetingItem newDoctor) returns Meeting|error? {
        ...
        Meeting|error doctor = addMeeting(newDoctor, userInfo.organization);
        return doctor;
    }
